...
declare module "hardhat/types/runtime" {
  export interface HardhatRuntimeEnvironment {
    readRandomNumber: (hre: HardhatRuntimeEnvironment, contractAddress: string) => Promise<string>
    requestRandomNumber: (hre: HardhatRuntimeEnvironment, contractAddress: string) => Promise<void>
  }
}
